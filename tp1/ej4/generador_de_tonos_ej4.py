...
def generate_tone(amplitude, frequency, duration, sample_rate=44100):
    """
    Genera un tono en forma de onda coseno.

    Argumentos:
        amplitude (float): Multiplica por un factor de escala la amplitud de la señal
...
def ejc4():
     # Parámetros comunes
        ...
        senial1 = generate_tone(amplitud1, frecuencia1, duracion, fs)
        ...
        senial2 = generate_tone(amplitud2, frecuencia2, duracion, fs)
